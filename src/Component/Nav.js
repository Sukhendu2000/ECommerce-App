...
return (
    <nav
      className="navbar navbar-expand-lg p-4 align-items-center gradient-custom"
      style={style.nav}
    >
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link to="/" className="nav-link active text-white fw-bold" href="#">
                Products
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/addproducts" className="nav-link active text-white fw-bold">
                Add a product
              </Link>
            </li>
          </ul>
